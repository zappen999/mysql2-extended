...
class MySQL2Extended extends QueryInterfaceAbstract {
	constructor (protected driverInstance: MySQL2DriverInstance) {
		super()
	}

	/**
	 * Implements QueryInterfaceAbstract.getConnection by using a new connection
	 * from the driver every time.
	 */
	protected async getConnection (): Promise<DriverConnection>  {
